...
namespace MemberService.Migrations
{
    ...
    [Migration("20180914112741_ToLocale")]
    partial class ToLocale
    {
            ...
            modelBuilder.Entity("MemberService.Models.AttendanceInfo", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1L, DayOff = 0, Late = 1, SickUnverified = 1, SickVerified = 0 },
                        new { Id = 2L, DayOff = 0, Late = 14, SickUnverified = 2, SickVerified = 2 },
                        new { Id = 3L, DayOff = 2, Late = 5, SickUnverified = 1, SickVerified = 0 }
                    );
                });
            ...
            modelBuilder.Entity("MemberService.Models.JobHistory", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1L, Name = "Economist" },
                        new { Id = 2L, Name = "Teacher" },
                        new { Id = 3L, Name = "Psychologist" }
                    );
                });
            ...
            modelBuilder.Entity("MemberService.Models.JoinModels.ClassProfile", b =>
                {
                    ...
                    b.HasData(
                        new { ClassId = 1L, ProfileId = 2L },
                        new { ClassId = 2L, ProfileId = 1L },
                        new { ClassId = 3L, ProfileId = 3L }
                    );
                });
            ...
            modelBuilder.Entity("MemberService.Models.Profile", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1L, DateOfBirth = new DateTime(2017, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Education = 2, Email = "x", Gender = 0, GitHubUser = "x", IsSigned = true, Level = 3, LinkedIn = "x", Name = "Adam", Payment = 1, Phase = 0, PhoneNumber = "x", Picture = "x", SlackUser = "x" },
                        new { Id = 2L, DateOfBirth = new DateTime(2017, 1, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), Education = 4, Email = "x", Gender = 0, GitHubUser = "x", IsSigned = true, Level = 0, LinkedIn = "x", Name = "Eva", Payment = 1, Phase = 0, PhoneNumber = "x", Picture = "x", SlackUser = "x" },
                        new { Id = 3L, DateOfBirth = new DateTime(2017, 1, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), Education = 0, Email = "x", Gender = 1, GitHubUser = "x", IsSigned = true, Level = 1, LinkedIn = "x", Name = "Janos", Payment = 0, Phase = 1, PhoneNumber = "x", Picture = "x", SlackUser = "x" }
                    );
                });
            ...
            modelBuilder.Entity("MemberService.Models.Project", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1L, Description = "Csharp", Name = "Marvin" },
                        new { Id = 2L, Description = "JAVA", Name = "Szera" },
                        new { Id = 3L, Description = "Python, DevOps", Name = "Malachite" }
                    );
                });
            ...
            modelBuilder.Entity("MemberService.Models.Team", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1L, Name = "Amazonite" },
                        new { Id = 2L, Name = "Malachite" }
                    );
                });
